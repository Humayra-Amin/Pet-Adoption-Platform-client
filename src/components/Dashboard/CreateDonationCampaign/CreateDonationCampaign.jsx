...
const CreateDonationCampaign = () => {
    ...
    const handleAddDonation = async (event) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/addDonationCampaign', newDonationCampaign);
    ...
    return (
        <div>
            <Helmet>
                <title>PawPets | Create Donation Campaign</title>
            </Helmet>
            <div className="flex">
                        ...
                        <div className="card shrink-0 lg:w-[700px] bg-base-100">
                            <form onSubmit={handleAddDonation} encType="multipart/form-data" className="card-body border-2 border-green-600 p-14 shadow-2xl rounded-xl">
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="petName" value={petName} onChange={(e) => setPetName(e.target.value)} placeholder="Pet Name" className="input input-bordered w-full" />
                                </div>
                                <div className="form-control">
                                    <label className="label">
