...
export default function UserTableAdoptionReq() {
    const { user } = useAuth();
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="flex space-x-2">
                    {parseInt(row.original.isAcceptedRequest) === 0 ? (
                        <div>
                            <button
                                className="px-2 py-1 mr-2 bg-green-500 text-white rounded hover:bg-blue-600"
                    ...
                    ) : parseInt(row.original.isAcceptedRequest) === 1 ? (
                        <button className="px-2 py-1 bg-green-500 text-white rounded hover:bg-blue-600">
                            Accepted
                        </button>
                    ) : (
                        <button className="px-2 py-1 mr-2 bg-red-500 text-white rounded hover:bg-blue-600">
                            Rejected
                        </button>
                    )}
                </div>
